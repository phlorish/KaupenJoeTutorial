...
{
    SAPPHIRE("sapphire", 26, new int[]{5,7,5,4}, 25, SoundEvents.ARMOR_EQUIP_GENERIC, 1f, 0f, () -> Ingredient.of(ModItems.SAPPHIRE.get()));
    ...
    {
        return PhlorishTutorial.MODID + ":" + this.name;
    }
